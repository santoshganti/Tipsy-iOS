...
class FacebookAPIManager {
    ...
    func requestFacebookUser(completion: @escaping (_ facebookUser: FacebookUser) -> Void) {
        let graphRequest = GraphRequest(graphPath: kGraphPathMe, parameters: ["fields":"id,email,last_name,first_name,picture"], tokenString: accessToken, version: .GET, HTTPMethod: .defaultVersion)
